...
graph TD
    ...
    classDef config fill:#64748b,stroke:#e2e8f0,color:white,stroke-dasharray: 5 5;
    classDef core fill:#3b82f6,stroke:#3b82f6,color:white,font-weight:bold;
    classDef airs fill:#22c55e,stroke:#16a34a,color:white,font-weight:bold,stroke-width:2px;
    classDef airsserver fill:#22c55e,stroke:#16a34a,color:white,stroke-width:2px,stroke-dasharray: 3 3;
    classDef memory fill:#1e293b,stroke:#60a5fa,color:#60a5fa,stroke-width:1px;
    classDef prompts fill:#fb923c,stroke:#f97316,color:white;
    classDef rag fill:#a855f7,stroke:#9333ea,color:white;
    classDef mcp fill:#14b8a6,stroke:#0d9488,color:white;
    classDef gateway fill:#2563eb,stroke:#1e40af,color:white;
    classDef model fill:#2563eb,stroke:#1e40af,color:white,stroke-dasharray: 2 2;
